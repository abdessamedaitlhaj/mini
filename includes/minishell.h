...
/*   Updated: 2024/07/07 09:45:08 by aait-lha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_cmd
{
	...
	int				append;
	int				args_number;
	int				flag_infiles;	// 1 for infile 2 for heredoc 0 not found
	int				flag_outfiles;// 1 for outfile 2 for append 0 not found
}	t_cmd;
